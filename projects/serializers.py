...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Project
        fields = [
            "id", "title", "description", "status", "key", "jira_url", "jira_project_id", "project_role"
        ]
        read_only_fields = ["id", "jira_project_id", "project_role"]
    ...
    def validate(self, data):
        ...
        if self.instance:
            ...
            required_jira_fields = ["key", "title", "jira_url"]
